...
class ProductOverlayButton extends HTMLElement {
  constructor() {
    super();
    this.addEventListener("click", this.openOverlay.bind(this));
  }
  openOverlay() {
    let overlay = document.querySelector(
      `[data-overlayProduct='${this.dataset.productid}']`
    );
...
class ProductOverlay extends HTMLElement {
  constructor() {
    ...
    this.querySelector(".close_icon").addEventListener(
      "click",
      this.close.bind(this.parentElement)
    );
    this.option_wrapper = this.querySelector(".size_wrapper");
    this.size_text = this.querySelector(".size_div");
    this.size_text.addEventListener(
      "click",
      this.open.bind(this.option_wrapper)
    );
    this.option_wrapper
  ...
  onSize(sizeElement) {
    ...
    size_box.classList.add("size_box");
    size_box.textContent = sizeText;
...
customElements.define("product-card-overlay", ProductOverlay);

const header_wrapper = document.querySelector(".header_wrapper");
const hamburger = document.querySelector(".mobile .hamburger");
const close = document.querySelector(".mobile .close");
hamburger.addEventListener("click", function () {
  header_wrapper.classList.add("open");
});
close.addEventListener("click", function () {
  header_wrapper.classList.remove("open");
});
